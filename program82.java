...
//                It also handles negative input by converting it into positive
...
class Number
{
    ...
    //                  It handles negative input by converting it into positive
    //  Input         : Integer
    //  Output        : Boolean
    //  Author        : Varad Nitin Muley
    //  Date          : 09/10/2025
    ...
    public boolean CheckPerfect(int iNo)
    {
        ...
        return (iSum == iNo);                                 // Return statement (change)
    }   // End of CheckPerfect
